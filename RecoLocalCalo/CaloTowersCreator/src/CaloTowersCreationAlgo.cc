...
void CaloTowersCreationAlgo::assignHit(const EcalRecHit* recHit) {
...
unsigned int CaloTowersCreationAlgo::ecalChanStatusForCaloTower(const EcalRecHit* hit) {
